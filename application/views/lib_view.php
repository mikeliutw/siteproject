        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?=base_url()?>index.php/login/reg">Sign Up</a>
                    </li>
                      <?
                    }else{
                        ?>
                           <li>
                        <a href="<?=base_url()?>">Welcome <?php echo $this->session->userdata('frontusername')?></a>
                    </li>

                    <li>
                        <a href="<?=base_url()?>index.php/reservlist">List</a>
                    </li>
